...
namespace SFA.DAS.Payments.ScheduledJobs.V1.Validator
{
    public class LevyAccountValidator : AbstractValidator<LevyAccountsDto>
    {
        ...
        {
            _telemetry.TrackEvent("EmployerAccountReferenceData.Comparison.MissingLevyAccount", new Dictionary<string, string>
            {
        ...
        {
            _telemetry.TrackEvent("EmployerAccountReferenceData.Comparison.IsLevyPayerMismatch", new Dictionary<string, string>
            {
        ...
        {
            _telemetry.TrackEvent("EmployerAccountReferenceData.Comparison.TransferAllowanceMismatch", new Dictionary<string, string>
            {
        ...
        {
            _telemetry.TrackEvent("EmployerAccountReferenceData.Comparison.BalanceMismatch", new Dictionary<string, string>
            {
